...
class BookkategoripageView extends GetView<BookkategoripageController> {
  const BookkategoripageView({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        titleSpacing: -10,
        title: Text(
         Get.parameters['namaKategoriBuku'].toString(),
                ...
                child: Center(
                  child: Padding(
                    ...
                    child: CustomSearchTextField(
                        ...
                        onChanged: (value){
                          controller.getDataBukuByKategori();
                        },
                ...
                child: Padding(
                  ...
                  child: Container(
                    ...
                    child: Obx((){
                      ...
                      }else if (controller.dataKategoriBook.isEmpty){
  ...
  Widget sectionAllBook(double width){
    return GridView.builder(
      gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
        ...
        childAspectRatio: 6 / 11.3,
      ),
      itemCount: controller.dataKategoriBook.length,
      itemBuilder: (context, index){
        ...
        if (index == controller.dataKategoriBook.length - 1) {
          itemPadding = const EdgeInsets.only(bottom: 10);
        }

        var bukuList = controller.dataKategoriBook[index];
        return InkWell(
          onTap: () {
